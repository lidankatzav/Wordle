...
export function Topbar():  JSX.Element {
    ...
    const {isInfo, setIsInfo} = useContext(TopbarContext);
    ...
    <ul className="navbar-nav flex-row align-items-center me-2 mb-1">
      ...
      <li className="nav-item me-3 me-lg-1">
        <button type="button" className="btn btn-dark btn-lg btn-floating">
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="40" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
      ...
      <li className="nav-item me-3 me-lg-1">
        <button type="button" className="btn btn-dark btn-lg btn-floating">
                <img src="https://www.nicepng.com/png/full/6-63506_usa-png-clipart-american-flag-icon-png.png" width="60" height="40" className="bi bi-person-circle" />
    ...
    <ul className="navbar-nav flex-row align-items-center me-2 mb-1">
      ...
      <li className="nav-item me-3 me-lg-1">
        <button type="button" className="btn btn-dark btn-lg btn-floating" onChange = {() => setIsInfo(!isInfo)} data-mdb-toggle="modal" data-mdb-target="#staticBackdrop" >
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="40" fill="currentColor" className="bi bi-info-circle" viewBox="0 0 16 16">
      ...
      <li className="nav-item me-3 me-lg-1">
        <button type="button" className="btn btn-dark btn-lg btn-floating">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="40" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16">
