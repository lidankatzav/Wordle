...
export function Topbar():  JSX.Element {
    ...
    <ul className="navbar-nav flex-row align-items-center me-2 mb-1">
      ...
      <li className="nav-item me-3 me-lg-1">
        <button type="button" className="btn btn-secondary">
                <img src="https://www.nicepng.com/png/full/6-63506_usa-png-clipart-american-flag-icon-png.png" width="55" height="35" className="bi bi-person-circle" />
    ...
    <ul className="navbar-nav flex-row align-items-center me-2 mb-1">
      ...
      <li className="nav-item me-3 me-lg-1">
        <button type="button" className="btn btn-secondary" onClick = {() => setShowInfo(true)} data-mdb-toggle="modal" data-mdb-target="#staticBackdrop" >
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-info-circle" viewBox="0 0 16 16">
